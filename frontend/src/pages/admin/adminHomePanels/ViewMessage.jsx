...
const ViewMessage = ({ setViewMessage, singleMessageContent, deleteSingleMessage, fetchMessages }) => {
    const deleteMessage = () => {
                ...
                <div className='bg-primaryBg text-primaryText overflow-y-auto w-full pb-6 min-h-[40vh]'>
                    <div className='flex sticky top-0 bg-primaryBg justify-between items-center p-2 mb-4 shadow-xl px-6'>
                        ...
                        <div className='flex items-center gap-1'>
                            ...
                            <RxCross1 className='hover:bg-borderColor p-2 rounded-full text-4xl cursor-pointer' onClick={() => closeMessage()} />
                        </div>
                    </div>
                    <div className='px-6'>
