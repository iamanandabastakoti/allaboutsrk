...
const Navbar = () => {
    ...
    return (
        <div className='sticky top-0 shadow-2xl z-[1000] w-full flex items-center justify-between p-2 bg-navbarBg text-primaryBg min-h-12 font-MontserratAlternate  font-semibold text-xl'>
            <h1>All About SRK</h1>
